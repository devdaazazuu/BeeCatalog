...
MAPA_UNIDADES = {
    "Unidade de peso do pacote":         "Gramas",
    "Unidade de peso da tela do item":   "Gramas",
    "Unidade de Peso do Pacote Principal": "Gramas",
    "Unidade de peso do item": "Gramas",
    ...
    "Unidade de Comprimento do Pacote Principal": "Centímetros",
    "Unidade de Altura do Pacote Principal":     "Centímetros",
    "Unidade de Largura do Pacote Principal":     "Centímetros",
    "Unidade de comprimento do item":    "Centímetros",
    "Unidade de largura do item":        "Centímetros",
    "Unidade de altura do item":         "Centímetros",
}
...
def get_main_ia_chain():
    ...
    prompt_template = PromptTemplate(
        ...
        PALAVRAS-CHAVE
        Inclua entre 10 a 15 palavras-chave relevantes, separadas por ponto e vírgula.
...
def escolher_com_ia(product_data: dict, fields_to_fill: List[Dict], assumed_items: FrozenSet[Tuple[str, str]], retriever) -> Tuple[Dict[str, str], int]:
    ...
    try:
        ...
        if json_match:
            return json.loads(json_match.group(0)), total_tokens
        return {}, total_tokens
...
def processar_chunk_com_ia(chunk_name: str, chunk_data: dict, product_data: dict, retriever_context_info: str, campos_criticos: set, persona_especialista: str):
    ...
    prompt_final = (
        ...
        "2.  **PENSE PASSO A PASSO:**...\n"
        "3.  **SAÍDA EXCLUSIVAMENTE EM JSON:**...\n"
        "4.  **CHAVES EXATAS:**...\n"
